...
is_public_service_by_organization_name = {
    ...
    u'agence-de-services-et-de-paiement-asp': True,
    ...
    u'departement-de-loire-atlantique': True,
    ...
    u'mairie-de-monacia-d-aullene': True,
    ...
    u'observatoire-national-de-la-delinquance-et-des-reponses-penales-ondrp': True,
    ...
    u'senat': True,
    u'service-d-information-du-gouvernement': True,
    u'shom': True,
    u'sncf': True,
